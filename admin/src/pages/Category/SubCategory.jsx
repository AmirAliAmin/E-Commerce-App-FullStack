         ...
         <div className="flex items-center justify-between flex-wrap">
                 ...
                 <div className="w-full md:w-[40%] lg:w-[50%] ml-auto flex justify-end items-center flex-wrap gap-3 px-2">
                     ...
                     <button className="border border-primary hover:bg-primary hover:text-white cursor-pointer text-[13px] text-primary py-2 px-5 rounded whitespace-nowrap flex  items-center" variant="outlined" onClick={()=>setOpenFullScreenPanel({
                       ...
                       })}><GoPlus />Add Sub Category</button> 
                   </div>
                     </div>
               ...
               <tbody>
                   ...
                   <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                     <div className="flex items-center gap-2">
                       <h1 className="font-medium text-black">Fashion</h1>
                     </div>
                   </td>
     
                   <td className="px-6 py-4 whitespace-nowrap">
                     <div className="flex items-center gap-2">
                       <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Men<IoIosClose/></div>
                       <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Women <IoIosClose/></div>
                        <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Kids <IoIosClose/></div>
                 ...
                 <tr className="bg-white border-b border-gray-200">
                    <td className="px-6 py-4">
                     ...
                     <td className="px-6 py-4 whitespace-nowrap">
                     <div className="flex items-center gap-2">
                       <h1 className="font-medium text-black">Electronics</h1>
                     </div>
                   </td>
                   ...
                   <td className="px-6 py-4 whitespace-nowrap">
                     <div className="flex items-center gap-2">
                       <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Mobile<IoIosClose/></div>
                       <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Laptop <IoIosClose/></div>
                        <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Cameras <IoIosClose/></div>
                         <div className="bg-primary text-white py-1 px-3 flex items-center justify-between gap-2 rounded-lg">Smart Watch <IoIosClose/></div>
                     </div>
                   </td>
                 </tr>
               </tbody>
