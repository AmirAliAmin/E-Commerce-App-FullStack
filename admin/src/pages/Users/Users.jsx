                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-4  overflow-y-auto">
                      ...
                      <img
                        ...
                        alt=""
                        className="w-16.25 h-16.25 min-w-15 rounded-full border object-cover"
                      />
                    
                    
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">Amir Ali Amin</td>
                <td className="px-6 py-4 whitespace-nowrap">aliaminamir77@gmail.com</td>
